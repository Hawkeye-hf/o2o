<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"G:\u0umwr\public/../application/admin\view\category\index.html";i:1545123227;s:61:"G:\u0umwr\public/../application/admin\view\public\header.html";i:1543571447;s:61:"G:\u0umwr\public/../application/admin\view\public\footer.html";i:1543557255;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	...
	<!--<img style="margin:20px" width="280" height="140" src="<?php echo url('index/test'); ?>" />-->
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<?php if(is_array($categorys) || $categorys instanceof \think\Collection || $categorys instanceof \think\Paginator): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td><?php echo date("Y-m-d H:i:s",strtotime($vo['create_time'])); ?></td>
