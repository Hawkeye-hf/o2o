<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"G:\u0umwr\public/../application/admin\view\category\edit.html";i:1543995735;s:61:"G:\u0umwr\public/../application/admin\view\public\header.html";i:1543571447;s:61:"G:\u0umwr\public/../application/admin\view\public\footer.html";i:1543557255;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="parent_id" class="select">
					...
					<option value="<?php echo $vo['id']; ?>" <?php if($category['parent_id'] == $vo['id']): ?> selected="selected" <?php endif; ?>>
						--<?php echo $vo['name']; ?>
					</option>
